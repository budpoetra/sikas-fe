...
const AdvantagesSection: React.FC = () => {
    return (
        <section id="advantages" className="py-20 px-6 md:px-20 lg:px-40 bg-white">
                        ...
                        icon={
                            ...
                            >
                                ...
                                <g transform="translate(120,58)">
                                    <path d="M0 0 L10 12 L6 12 L12 22 L2 14 L8 14 Z" fill="#FBBF24" />
                                </g>

                                <g transform="translate(80,80) scale(0.7)">
                                    <path d="M4 18 L10 24 L22 8" stroke="#10B981" strokeWidth="3" fill="none" />
