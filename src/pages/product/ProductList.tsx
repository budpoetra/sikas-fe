...
export default function ProductList() {
  ...
  return (
    <>
      <PageMeta
        title="Products | TailAdmin - React.js Tailwind CSS Admin Dashboard Template"
        description="Manage products for the admin dashboard"
      />
                  ...
                  {products.length > 0 ? (
                    products.map((product) => (
                     <TableRow key={product.id}>
                      <TableCell className="px-4 py-3 text-theme-sm text-gray-800 dark:text-white/90">{product.id}</TableCell>
                      ...
                      <TableCell className="px-4 py-3 text-theme-sm text-gray-800 dark:text-white/90">{product.price !== undefined ? `$${product.price.toFixed(2)}` : 'N/A'}</TableCell>
